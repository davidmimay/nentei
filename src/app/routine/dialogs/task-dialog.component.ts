  ...
  template: `
    ...
    <div mat-dialog-content class="content">
      ...
      <div class="ngx-timepicker-field-example">
        <ngx-timepicker-field [controlOnly]="true" [format]="24" [defaultTime]="'06:00'"></ngx-timepicker-field>
      </div>
...
export class TaskDialogComponent {
  ...
  handleTaskDelete() {
    this.routineService.removeTask(this.data.routineId, this.data.task);
    this.dialogRef.close();
  }
}
